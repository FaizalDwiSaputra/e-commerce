...
<html lang="en">
  ...
  <body class="boy">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 col-6 mb-2">
          <div class="kartu mb-2">
            ...
            <div class="deskripsi-produk px-4 py-2">
              ...
              <h6 class="">Rp.<?=$data['harga_produk'];?></h6>
    ...
    <!-- FOOTER -->
    <div class="kontainer-footer  mx-lg-5 my-4  bg-secondary ">
      <div class="row">
        <div class="col-12 footerku justify-content-center">
          <p class="text-center text-light">Copyright &copy; <strong>ManWear</strong></p>
        </div>
      </div>
    </div>
