...
if($data['status_pembayaran'] == 'Sudah bayar') {
    ...
    exit();
}else if($data['status_pembayaran'] == 'Proses'){
    echo "<script>alert('Pesanan proses pengiriman');</script>";
    echo "<script>location='riwayat.php';</script>";
}
?>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 " >
            ...
            <li class="nav-item">
              <a class="nav-link" href="index.php?#kami">Tentang Kami</a>
            </li>
            <li class="nav-item">
...
<!-- KODE PHP -->
 <?php
    if(isset($_POST['kirim'])){
        ...
        if($jumlah != $data['total_pembelian']){
          echo "<script>alert('Mohon masukkan jumlah tagihan yang sesuai');</script>";
        }else{
